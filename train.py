...
#Scale weight
scale_pos_weight = (y_train == 0).sum() / (y_train == 1).sum() * 1.2 #Changed scale to favor drafted slightly more
...
model = xgb.XGBClassifier(
    ...
    subsample=0.75, #Best = 0.75, original = 0.8
    colsample_bytree=0.75, #Best = 0.75, original = 0.8
